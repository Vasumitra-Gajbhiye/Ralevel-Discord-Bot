...
function loadTaskDisplayWithMocks({
  ...
  const taskPath = require.resolve("../models/task.js");
  const taskDisplayPath = require.resolve("../models/taskDisplay.js");
  ...
  require.cache[taskDisplayPath] = {
    id: taskDisplayPath,
    filename: taskDisplayPath,
    loaded: true,
    exports: {
      findOne: (query) => ({
        lean: async () => {
